...
def login():
    # Prevents browse to /login by authenticated user.
    ...
    if form.validate_on_submit():
        ...
        # finds matching object in SQL database (from SQLAlchemy)
        # first() returns None or the object
...
# The chevrons indicate a dynamic component
